<div class="page-consultas-atendimento">
    ...
    <ul class="nav nav-tabs nav-atendimento" id="myTab" role="tablist" style="position: fixed;top:0;z-index:50; width: 100%">
        ...
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Hipotese diagnostica</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Receituario</button>
        </li>
    </ul>
    ...
    <div class="tab-content" id="myTabContent" style="margin-top:80px">
      <div class="tab-pane fade show active p-2" id="home" role="tabpanel" aria-labelledby="home-tab">
        <livewire:components.consultas.form-prontuario-ex-fisico :prontuario_id="$prontuario_id">
      </div>
